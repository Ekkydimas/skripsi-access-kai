...
# ==========================================
# 2. LOAD MODEL & DATASET (SAFE MAPPING FIX)
# ==========================================
@st.cache_resource
def load_model_and_tokenizer():
    ...
    # Standard mapping aman buat hindari KeyError
...
def predict_sentiment(text):
    ...
    # Safety get untuk cegah KeyError jika index berbeda
...
# ==========================================
# 6. TAB NAVIGASI UTAMA (RUTE ORIGINAL)
# ==========================================
...
with tab2:
    ...
    with ch2:
        ...
        sns.barplot(x=aspek_counts.values, y=aspek_counts.index, hue=aspek_counts.index, palette="mako", ax=ax2, legend=False)
